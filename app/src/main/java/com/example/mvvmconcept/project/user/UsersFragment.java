...
public class UsersFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getUserListUiState().observe(getViewLifecycleOwner(), new Observer<UserListUiState>() {
            @Override
            public void onChanged(UserListUiState userListUiState) {
                adapter.setUsers(userListUiState.getUsers());
            }
        });
